...
Usage: metrics-dashboard.py [project_dir]
"""
...
WIDTH = 80
GLOBAL_DIR = os.path.expanduser("~/.tech-essay-writer")
...
def usage():
    print("""Usage: metrics-dashboard.py [project_dir]
...
def main():
    ...
    if len(topics_written) >= 2:
        ...
        print("  Only 1 article in taste memory. Write more to see trends.")
        t = topics_written[0]
