...
# Usage: seo-metadata.sh <project_dir> [verbose]
set -euo pipefail
...
# Add top frequent words not already in keywords
...
tmp_file = os.path.join(state_dir, "seo-metadata.json.tmp." + str(os.getpid()))
